...
//渲染骨架
    xxim.view = (function () {
        var xximNode = xxim.layimNode = $('<div id="xximmm" class="xxim_main">'
            ...
            + '<i class="xxim_nowstate fa fa-chat-circle"></i><span id="xxim_onlinetex">在线</span>'
            + '<div class="xxim_setonline">'
            + '<span><i class="fa fa-chat-circle"></i>在线</span>'
            + '<span class="xxim_setoffline"><i class="fa fa-chat-circle"></i>隐身</span>'
            + '</div>'
            + '</li>'
