...
//<div class="ui-layout-east">东</div>
//<div class="ui-layout-south">南</div>
//<div class="ui-layout-west">西</div>
//<div class="ui-layout-north">北</div>
 ...
 */
        , panes: { // default options for 'all panes' - will be overridden by 'per-pane settings'
            ...
            , togglerContent_open: "<i class=\"fa\"></i>"	// ThinkGem 设置展开折叠图标，默认空""	// text or HTML to put INSIDE the toggler
            , togglerContent_closed: "<i class=\"fa\"></i>"	// ThinkGem 设置展开折叠图标，默认空""	// ditto
            //	RESIZING OPTIONS
        ...
        , _load: function (inst) {
            ...
            $.extend(inst, {
                bindButton: function (selector, action, pane) {
                    return $.layout.buttons.bind(inst, selector, action, pane);
                }
                //	DEPRECATED METHODS...
